...
import { setCors, requireApiKey, fetchTmdb, TMDB_INDUSTRY_FILTERS } from "./tmdb.js";
...
export default async function handler(req, res) {
  ...
  // Shorter cache window than other endpoints — trending data is meant to
  // feel current, so we don't want a stale list sitting at the edge for long.
